...
export default function HorizontalSlidePanel({
  ...
  const addProject = () => {
    const newProject: Project = {
      ...
      slides: [{ id: uuid(), backgroundColor: "#000000", elements: [], width: slideWidth, height: slideHeight }],
    };
  ...
  const addBlankSlide = (projectId: string) => {
    ...
    if (!project) return;
    const newSlide: Slide = { id: uuid(), backgroundColor: "#000000", elements: [], width: slideWidth, height: slideHeight };
