...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: "#060606" }}>
      ...
      {/* Topbar */}
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/5" style={{ background: "#0d0d0d" }}>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="rounded-2xl px-6 py-5" style={{ background: "#0d0d0d", border: "1px solid #1e1e1e" }}>
        ...
        <div className="rounded-2xl overflow-hidden" style={{ background: "#0d0d0d", border: "1px solid #1e1e1e" }}>
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#1e1e1e]">
            ...
            <button onClick={fetchUsers} disabled={loading} className="flex items-center gap-1.5 text-xs text-gray-500 hover:text-gray-300 transition-colors disabled:opacity-40">
